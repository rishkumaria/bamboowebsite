    ...
    <nav class="navbar navbar-expand-lg fixed-top dark-bg">
      ...
      <div id="navbarNavAltMarkup" class="collapse navbar-collapse">
        <ul id="navbar-nav" class="navbar-nav ml-auto">
          ...
          <li><a class="nav-item nav-link" href="#skills">Partners</a></li>
          <li><a class="nav-item nav-link" href="#portfolio">How to buy</a></li>
          <li><a class="nav-item nav-link" href="#contact">Tokenomics</a></li>
        </ul>
      </div>
    </nav>
    <Banner />
